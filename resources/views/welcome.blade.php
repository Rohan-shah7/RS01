...
<div class="relative bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-600 text-white overflow-hidden">
  ...
  <div class="relative z-10 flex flex-col items-center justify-center min-h-[80vh] px-6 text-center">
    ...
    <div class="flex flex-wrap gap-4 justify-center">
      <a href="#" class="px-6 py-3 rounded-lg bg-yellow-400 text-black font-semibold hover:bg-yellow-300 transition">
        Get Started
      </a>
      <a href="#" class="px-6 py-3 rounded-lg border border-white hover:bg-white hover:text-indigo-600 transition">
        Learn More
      </a>
    </div>
  </div>
